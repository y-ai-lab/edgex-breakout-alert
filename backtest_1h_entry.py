...
PAGE_SIZE = 640
ENTRY_CHUNK_MS = 24 * DAY_MS     # 576 x 1h bars, below the observed 640-row cap.
...
def main() -> None:
    ...
    summary_path = out_dir / "4h_exit_180d_summary.json"
    csv_path = out_dir / "4h_exit_180d_trades.csv"
